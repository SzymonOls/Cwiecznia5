...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var deptno = depts.Where(d => d.Loc == "CHICAGO").Select(d => d.DeptNo);
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var deptSal = emps.GroupBy(e => e.DeptNo).ToDictionary(g => g.Key, g => g.Average(e => e.Sal));
        
        var result = emps.Where(e => deptSal.ContainsKey(e.DeptNo)).Select(e => e.EName);
